    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((image) => (
                <div className="aspect-h-2 overflow-hidden rounded-lg max-w-[6rem] max-h-[6rem] mt-4">
                  <img
                    alt={image.alt}
                    src={image.src}
                    className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 max-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8 lg:pb-24 ">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className="font-semibold">Rs 900</p>
        ...
        <section className="pt-10">
          ...
          <div className="flex flex-wrap space-y-5 space-x-5">
